  ...
  <form class='form-horizontal' method='POST' action='login.php'>
    ...
    <div class='form-group'>        
      <div class='col-sm-offset-2 col-sm-10'>
        <button type='submit' name='login' value='login' class='btn btn-md btn-danger'>LOGIN</button>
...
function display_content2(){
	...
	<div class='container'>
		...
		<div class='col-sm-offset-1 col-sm-10' id='create'>
	        <a type='btn' name='register' value='register' class='btn btn-md btn-danger' href='register.php'>CREATE ACCOUNT</a>
